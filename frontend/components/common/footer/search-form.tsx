...
export default function SearchForm() {
    return (
        <form className='flex items-center justify-center py-2 sm:py-4'>
            <input type='text' placeholder='Search...' className='w-full sm:min-w-[30em] text-white sm:max-w-min bg-[#635e5e] focus:ring-0 focus:outline-none rounded-tl-sm rounded-bl-sm px-4 py-2' />
